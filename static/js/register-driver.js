document.addEventListener("DOMContentLoaded", function() {
    ...
    function checkFormValidity() {
        ...
        continueBtn.disabled = !formIsValid;
        continueBtn.style.backgroundColor = formIsValid ? 'blue' : '#ccc';
        continueBtn.style.color = formIsValid ? 'white' : '#666';
    }
    ...
    document.getElementById("registrationForm").addEventListener("submit", function(event) {
        ...
        if(paymentInfoSaved) {
            window.location.href = 'driver-auth'; // Redirect to main.html if payment info is saved
        }
    });
